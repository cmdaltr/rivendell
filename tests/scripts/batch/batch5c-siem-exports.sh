#!/bin/bash
# Batch 5c: SIEM Exports - Splunk/Elastic/Navigator (Single Test, 2-4+ hours)
# EXTREME CAUTION: Very long-running SIEM export test
...
BATCH_NAME="batch5c-siem-exports"
...
echo "======================================"
echo "BATCH 5c: SIEM Exports (EXTREME!)"
echo "======================================"
echo "Start: $(date)"
echo "Log: $LOG_FILE"
echo ""
echo "WARNING: This test takes 2-4+ HOURS"
...
# Restart Docker after test to free resources
echo ""
...
echo "Log: $LOG_FILE"
echo ""
echo "RECOMMENDATION: Restart Docker before next extreme test"
