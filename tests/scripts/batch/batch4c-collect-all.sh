#!/bin/bash
# Batch 4c: Collect All Files (Single Test, ~90 min)
# CAUTION: Long-running test that collects all file types
...
BATCH_NAME="batch4c-collect-all"
...
echo "======================================"
echo "BATCH 4c: Collect All Files (CAUTION)"
echo "======================================"
echo "Start: $(date)"
echo "Log: $LOG_FILE"
echo "Estimated duration: ~90 minutes"
echo ""
echo "WARNING: This test takes ~90 minutes"
echo ""
