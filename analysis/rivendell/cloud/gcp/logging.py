...
class CloudLoggingAnalyzer:
    ...
    def _format_log_entry(self, entry: Any) -> Dict[str, Any]:
        ...
        return {
            ...
            'proto_payload': self._format_proto_payload(entry.proto_payload) if hasattr(entry, 'proto_payload') and entry.proto_payload else None,
    ...
    def _format_proto_payload(self, proto_payload: Any) -> Dict[str, Any]:
        ...
        try:
            return {
                ...
                'caller_supplied_user_agent': proto_payload.get('requestMetadata', {}).get('callerSuppliedUserAgent'),
    ...
    def analyze_logs(self, log_file: str) -> Dict[str, Any]:
        ...
        for log in logs:
            ...
            if 'iam' in method_name.lower() and 'Set' in method_name or 'Create' in method_name or 'Update' in method_name:
